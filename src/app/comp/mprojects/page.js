    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-200 text-xl max-w-3xl mx-auto leading-relaxed mb-8">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <div
              className={`absolute -inset-1 bg-gradient-to-r ${project.gradient} rounded-lg blur opacity-20 group-hover:opacity-30 transition-opacity duration-500`}
            ></div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech) => (
                        <Badge
                          key={tech}
                          className="bg-gray-800/50 text-gray-300 border-gray-600 hover:border-cyan-500/50 hover:text-cyan-400 transition-colors duration-200"
                        >
                          {tech}
                        </Badge>
                      ))}
          ...
          <div className="flex items-center justify-center gap-8 mt-12">
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/10 backdrop-blur-sm group relative overflow-hidden"
              onClick={prevProject}
            >
            ...
            {projects.map((proj, index) => (
              <Card
                ...
                className={`cursor-pointer transition-all duration-300 overflow-hidden group ${
                  index === currentProject
                    ? "ring-2 ring-cyan-400 scale-105 shadow-xl shadow-cyan-400/20"
